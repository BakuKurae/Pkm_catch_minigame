//Implementacion de pantallas de "partida ganada" y "partida perdida". //<>//
//Implementacion de sistema de seguridad para no perder el documento de logros 
//utilizando el evento exit(), el cual almacena los datos de los logros antes de terminar
//la ejecucion del programa.
//Impresion del panel de logros e instruccion de salida.
//implementacion de la funcion para finalizar la ejecucion.
